...
const MARKET_BADGE_CONFIG = {
  ...
  TW: { label: '上市', className: 'border-sky-500/25 bg-sky-500/10 text-sky-500' },
  TWO: { label: '上柜', className: 'border-indigo-500/25 bg-indigo-500/10 text-indigo-500' },
  JP: { label: '日股', className: 'border-teal-500/25 bg-teal-500/10 text-teal-500' },
