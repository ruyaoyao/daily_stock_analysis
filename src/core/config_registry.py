...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "TW_RSS_NEWS_ENABLED": {
        "title": "Taiwan RSS News",
        "description": "Enable the free Taiwan finance RSS news source (no API key). Aggregates Traditional-Chinese feeds (Yahoo 股市 / 中央社 / 鉅亨网) for Taiwan stocks and market reviews; non-Taiwan queries are skipped automatically. Default: true.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "help_key": "settings.data_source.search_api_keys",
        "examples": [
            "TW_RSS_NEWS_ENABLED=true",
            "TW_RSS_NEWS_ENABLED=false",
        ],
        "docs": [
            {
                "label": "完整指南：搜索服务配置",
    ...
    "TW_RSS_FEED_URLS": {
        ...
        "help_key": "settings.data_source.search_api_keys",
        "examples": [
            "TW_RSS_FEED_URLS=https://tw.stock.yahoo.com/rss?category=news",
            "TW_RSS_FEED_URLS=https://feeds.feedburner.com/rsscna/finance,https://news.cnyes.com/rss/v1/news/category/headline",
        ],
        "docs": [
            {
                "label": "完整指南：搜索服务配置",
    ...
    "TW_RSS_GOOGLE_NEWS_ENABLED": {
        "title": "Taiwan RSS Google News",
        "description": "Enable Google News RSS for Taiwan stock queries (no API key). Default: true.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "TW_RSS_FINMIND_NEWS_ENABLED": {
        "title": "Taiwan RSS FinMind News",
        "description": "Enable FinMind TaiwanStockNews for Taiwan stock queries. Works without token; FINMIND_TOKEN improves quota. Default: true.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "NATIVE_GEMINI_ENABLED": {
        "title": "Native Gemini (header auth)",
        "description": "Call Google AI Studio directly with the x-goog-api-key header (instead of LiteLLM's ?key= query param), with multi-key rotation + retry. Only affects gemini/ models; other providers stay on LiteLLM. Default: false.",
        "category": "ai_model",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "NATIVE_GEMINI_BASE_URL": {
        "title": "Native Gemini Base URL",
        "description": "Override the native Gemini endpoint (e.g. a self-hosted Gemini-compatible gateway). Leave empty to use Google's generativelanguage endpoint.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "REPORT_LANGUAGE": {
        ...
        "description": "Default output language for reports and notification templates. Supported values: zh (Simplified), zh-Hant (Traditional, Taiwan), en. zh-Hant 需安装 opencc 才会转换正文为繁体。",
        "category": "notification",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
    ...
    "MARKET_CN_ENABLED": {
        "title": "A-share Market Enabled",
        "description": "Enable A-share (cn) data. When off, A-share stocks are not fetched/analyzed and cn is excluded from market review.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "display_order": 471,
        "help_key": "settings.system.market_review",
        "examples": ["MARKET_CN_ENABLED=true"],
        "docs": [
            {
                "label": "完整指南：环境变量完整列表",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#环境变量完整列表",
    ...
    "MARKET_HK_ENABLED": {
        "title": "HK Market Enabled",
        "description": "Enable Hong Kong (hk) data. When off, HK stocks are not fetched/analyzed and hk is excluded from market review.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "display_order": 472,
        "help_key": "settings.system.market_review",
        "examples": ["MARKET_HK_ENABLED=true"],
        "docs": [
            {
                "label": "完整指南：环境变量完整列表",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#环境变量完整列表",
    ...
    "MARKET_US_ENABLED": {
        "title": "US Market Enabled",
        "description": "Enable US (us) data. When off, US stocks are not fetched/analyzed and us is excluded from market review.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "display_order": 473,
        "help_key": "settings.system.market_review",
        "examples": ["MARKET_US_ENABLED=true"],
        "docs": [
            {
                "label": "完整指南：环境变量完整列表",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#环境变量完整列表",
    ...
    "MARKET_TW_ENABLED": {
        "title": "Taiwan Market Enabled",
        "description": "Enable Taiwan (tw) data. When off, Taiwan stocks are not fetched/analyzed and tw is excluded from market review.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "display_order": 474,
        "help_key": "settings.system.market_review",
        "examples": ["MARKET_TW_ENABLED=true"],
        "docs": [
            {
                "label": "完整指南：环境变量完整列表",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#环境变量完整列表",
    ...
    "MARKET_REVIEW_REGION": {
        ...
        "description": "Market region for review: cn (A-shares), hk (Hong Kong), us (US stocks), tw (Taiwan), or both (=cn+hk+us). tw is selected explicitly; comma combos like cn,tw are supported.",
        "category": "system",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
...
_FIELD_HELP_METADATA: Dict[str, Dict[str, Any]] = {
    ...
    "NATIVE_GEMINI_ENABLED": {
        "help_key": "settings.ai_model.legacy_provider_params",
        "examples": [
            "NATIVE_GEMINI_ENABLED=true",
            "NATIVE_GEMINI_ENABLED=false",
        ],
        "docs": _DOC_LLM_CONFIG,
        "warning_codes": [],
    },
    "NATIVE_GEMINI_BASE_URL": {
        "help_key": "settings.ai_model.legacy_provider_params",
        "examples": [
            "NATIVE_GEMINI_BASE_URL=https://generativelanguage.googleapis.com/v1beta/models",
        ],
        "docs": _DOC_LLM_CONFIG,
        "warning_codes": [],
    },
