...
SUPPORTED_REPORT_LANGUAGES = ("zh", "zh-Hant", "en")

# normalize_report_language lowercases input before alias lookup, so a raw input
# like "zh-Hant" becomes "zh-hant" here → resolves to canonical "zh-Hant" which IS
# in SUPPORTED_REPORT_LANGUAGES.  Future maintainers: do NOT change alias values to
# lowercase — the canonical codes ("zh-Hant") are intentionally mixed-case.
_REPORT_LANGUAGE_ALIASES = {
    # Simplified Chinese variants → "zh"
    "zh-cn": "zh",
    "zh_cn": "zh",
    "zh-hans": "zh",
    "zh_hans": "zh",
    "cn": "zh",
    "chinese": "zh",
    # Traditional Chinese variants → "zh-Hant"
    "zh-tw": "zh-Hant",
    "zh_tw": "zh-Hant",
    "zh-hant": "zh-Hant",
    "zh_hant": "zh-Hant",
...
_OPERATION_ADVICE_TRANSLATIONS = {
    "strong_buy": {"zh": "强烈买入", "zh-Hant": "強烈買入", "en": "Strong Buy"},
    "buy": {"zh": "买入", "zh-Hant": "買進", "en": "Buy"},
    "hold": {"zh": "持有", "zh-Hant": "持有", "en": "Hold"},
    "watch": {"zh": "观望", "zh-Hant": "觀望", "en": "Watch"},
    "reduce": {"zh": "减仓", "zh-Hant": "減碼", "en": "Reduce"},
    "sell": {"zh": "卖出", "zh-Hant": "賣出", "en": "Sell"},
    "strong_sell": {"zh": "强烈卖出", "zh-Hant": "強烈賣出", "en": "Strong Sell"},
}
...
_TREND_PREDICTION_TRANSLATIONS = {
    "strong_bullish": {"zh": "强烈看多", "zh-Hant": "強勢多頭", "en": "Strong Bullish"},
    "bullish": {"zh": "看多", "zh-Hant": "偏多", "en": "Bullish"},
    "sideways": {"zh": "震荡", "zh-Hant": "盤整", "en": "Sideways"},
    "bearish": {"zh": "看空", "zh-Hant": "偏空", "en": "Bearish"},
    "strong_bearish": {"zh": "强烈看空", "zh-Hant": "強烈看空", "en": "Strong Bearish"},
}
...
_CONFIDENCE_LEVEL_TRANSLATIONS = {
    "high": {"zh": "高", "zh-Hant": "高", "en": "High"},
    "medium": {"zh": "中", "zh-Hant": "中", "en": "Medium"},
    "low": {"zh": "低", "zh-Hant": "低", "en": "Low"},
}
...
_CHIP_HEALTH_TRANSLATIONS = {
    "healthy": {"zh": "健康", "zh-Hant": "健康", "en": "Healthy"},
    "average": {"zh": "一般", "zh-Hant": "一般", "en": "Average"},
    "caution": {"zh": "警惕", "zh-Hant": "警示", "en": "Caution"},
}
...
_BIAS_STATUS_TRANSLATIONS = {
    "safe": {"zh": "安全", "zh-Hant": "安全", "en": "Safe"},
    "caution": {"zh": "警戒", "zh-Hant": "警戒", "en": "Caution"},
    "danger": {"zh": "危险", "zh-Hant": "危險", "en": "Danger"},
}
...
_CHIP_UNAVAILABLE_BY_LANGUAGE = {
    ...
    "zh-Hant": "籌碼分佈未啟用或資料來源暫不可用，未納入籌碼判斷。",
...
def localize_trend_prediction(value: Any, language: Optional[str]) -> str:
    ...
    if not raw_text:
        return raw_text
    if normalized_language in ("zh", "zh-Hant"):
